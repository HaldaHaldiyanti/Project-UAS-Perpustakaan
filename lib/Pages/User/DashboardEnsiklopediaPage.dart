...
class DashboardEnsiklopediaPage extends StatefulWidget {
  final String userKey;

  const DashboardEnsiklopediaPage({required this.userKey});

  @override
  _DashboardEnsiklopediaPageState createState() =>
      _DashboardEnsiklopediaPageState();
}

class _DashboardEnsiklopediaPageState extends State<DashboardEnsiklopediaPage> {
  ...
  Future<List<Book>> fetchBooks() async {
    ...
    if (response.statusCode == 200) {
      ...
      jsonData.forEach((key, value) {
        if (value['kategori'] == 'Ensiklopedia') {
          Book book = Book(
            id: key,
            judul: value['judul'],
