...
class DashboardNovelPage extends StatefulWidget {
  final String userKey;

  const DashboardNovelPage({required this.userKey});

  @override
  _DashboardNovelPageState createState() => _DashboardNovelPageState();
}

class _DashboardNovelPageState extends State<DashboardNovelPage> {
